...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if isLogin {
            let vc = sb.instantiateViewController(withIdentifier: "TabViewController") as! UITabBarController
...
//            let rootViewController = storyboard.instantiateViewController(withIdentifier: "TabViewController") as! UITabBarController
////            rootViewController.selectedIndex = 0
//            //            let tab = UITabBarController(rootViewController:rootViewController)
